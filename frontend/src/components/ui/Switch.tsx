...
export type SwitchVariant = 'default' | 'violet'
...
export interface SwitchProps
  extends Omit<
    ...
    'children'
  > {
  /** Visual variant for checked track color (default: primary). */
  variant?: SwitchVariant
}

/**
 * Accessible toggle aligned with headless-primitive patterns (similar in spirit to
 * component registries that document props, variants, and a11y — e.g. Kumo UI registry).
 */
